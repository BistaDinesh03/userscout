/* â”€â”€ Relevance scoring model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
 * Deterministic and explainable. Every prospect gets:
 *   score (0â€“100, capped) Â· confidence Â· signals[] Â· evidence[] Â· explanation
 *
 * Signal weights (documented â€” also shown in the UI and README):
 ...
 * reachable score is 43, which lands in the LOW band. This is deliberate â€”
 * "uses the same language" is not evidence of need.
 *
 * Confidence: HIGH requires score â‰¥ 70 AND a strong signal â‰¥ 20 pts.
 *             MEDIUM requires score â‰¥ 45 or any strong signal.
 *             Otherwise LOW.
 */
...
export const SIGNAL_DOCS: { id: SignalId; label: string; max: number; rule: string }[] = [
  { id: "asking", label: "Problem evidence", max: 30, rule: "Publicly asked for or discussed this exact problem (issue title/body). Question-shaped: 30 Â· discussion: 20." },
  ...
  { id: "recency", label: "Recent relevant activity", max: 15, rule: "Related public activity â‰¤30d: 15 Â· â‰¤90d: 10 Â· â‰¤180d: 6 Â· â‰¤1y: 3." },
...
export function scoreCandidate(profile: ProjectProfile, c: DiscoveryCandidate): ScoredCandidate {
  ...
  /* audience â€” weak */
  {
    ...
    add(
      "audience",
      hit ? 8 : 0,
      hit ? [{ kind: "profile", text: `Profile aligns with target audience: â€œ${hit}â€.` }] : [],
    );
  }
